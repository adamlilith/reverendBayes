...
code <- nimbleCode({
	...
	# simulate the data and calculate an auxiliary variable
...
The chains look well-mixed in the trace plots (right column), but the "lumpy" appearance of the posterior (the plots on the left) suggests that we should probably run the model for more iterations. But we'll live with this for now.
